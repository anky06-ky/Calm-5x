export const teamMembers = [
  {
    ...
    socials: {
      ...
      email: 'thinh.hoang@calmx.app'
    },
    quote: 'Chăm sóc sức khỏe tinh thần không phải là đích đến, mà là hành trình check-in mỗi ngày.'
  },
  {
    id: 'sang-huynh',
    ...
    image: '/members/Huỳnh_Quang_Sang.png',
    isPlaceholder: false,
  ...
  },
  {
    ...
    image: '/members/Nguyễn_Phạm_Trọng_Khang.png',
    isPlaceholder: false,
...
export const advisors = [
  {
    name: 'Th.S Phạm Thiên Vũ',
    role: 'Cố vấn Định hướng & Mô hình Kinh doanh',
    org: 'HUIT Startup Advisor',
    desc: 'Hướng dẫn nhóm Khát Vọng tối ưu mô hình Freemium/B2B Pilot và định hình thông điệp xã hội.'
  },
  {
    name: 'BS.CK1 Lư Trọng Tín',
    role: 'Cố vấn Chuyên môn Sức khỏe Tinh thần',
    org: 'Chuyên gia Tâm lý & Y tế',
    desc: 'Tư vấn chuyên môn y khoa, đảm bảo tính an toàn và chuẩn mực cho các gợi ý từ AI Caly.'
  }
];

export const projectMilestones = [
  { step: '01', title: 'Mở Ứng Dụng', desc: 'Truy cập CalmX với giao diện thư giãn, chào đón cá nhân hóa.' },
  { step: '02', title: 'Check-in Cảm Xúc', desc: 'Ghi nhận trạng thái tâm trạng hôm nay từ Rất tệ đến Rất tốt.' },
  { step: '03', title: 'Trò Chuyện AI Caly', desc: 'Lắng nghe phản hồi dịu nhẹ và gợi ý bài tập hít thở phù hợp.' },
  { step: '04', title: 'Theo Dõi Xu Hướng', desc: 'Quan sát biểu đồ biến đổi cảm xúc 7 ngày để thấu hiểu bản thân.' },
  { step: '05', title: 'Kết Nối Chuyên Gia', desc: 'Đặt lịch tư vấn CalmX Care khi cần hỗ trợ chuyên sâu hơn.' }
];
